                ...
                <Listbox value={editFolder || ""} onChange={val => setEditFolder(val || null)}>
                  <div className="relative">
                    ...
                    <Transition as={Fragment} leave="transition ease-in duration-100" leaveFrom="opacity-100" leaveTo="opacity-0">
                      <Listbox.Options className="absolute z-10 mt-1 w-full max-h-60 overflow-auto rounded-lg bg-white/10 backdrop-blur-xl border border-white/30 shadow-xl focus:outline-none">
